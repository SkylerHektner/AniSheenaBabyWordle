...
`;
    ...
    // IF WE DECIDE TO RE-ADD A NAME LIST IT GOES HERE
      , Ia = "present"
      , Ma = "correct"
      , Oa = "absent";
    var Ra = {
        ...
        return o(t, [{
            ...
            value: function() {
                if (5 === this.tileIndex && !(this.rowIndex >= 6)) {
                    ...
                    // DISABLED WORD LIST, NOW ANY WORD WORKS
                    // if (e = s,
  ...
  ***************************************************************************** */
  ...
  <div class="container">
    ...
    <h1>born at</h1>${born_at}
    <h1>on</h1>${date_on}
    <h1>She weighs</h1>${weight}
    <h1>And is</h1>${baby_length}
